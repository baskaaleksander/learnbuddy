...
import { BookDown, MessageCircleQuestion, NotebookText, Zap } from 'lucide-react'
    ...
    const features = [
        {
            ...
            description: 'Generate study materials instantly with the power of AI, saving you time and effort.',
            icon: <Zap />
        },
        {
            title: 'Flashcards',
            description: 'Create and customize flashcards for effective learning and quick revision.',
            icon: <BookDown />
        },
        {
            title: 'Summaries',
            description: 'Summarize complex topics into concise notes for easier understanding and retention.',
            icon: <NotebookText />
        },
        {
            title: 'Quizzes',
            description: 'Test your knowledge with quizzes that adapt to your learning pace and style.',
