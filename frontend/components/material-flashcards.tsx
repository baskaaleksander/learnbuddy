...
import { Check, Play, ReceiptText, RefreshCw, Target, Trash2, X } from 'lucide-react';
                        ...
                        <div className="space-y-4 mb-6">
                            <div className="grid grid-cols-2 gap-3">
                                <div className="text-center p-3 bg-muted/50 rounded-lg">
                                    ...
                                    <div className="text-xl font-bold">{flashcardsStats.known}</div>
                                ...
                                <div className="text-center p-3 bg-muted/50 rounded-lg">
                                    ...
                                    <div className="text-xl font-bold">{flashcardsStats.review}</div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="text-center p-3 bg-muted/50 rounded-lg">
                                    ...
                                    <div className="text-lg font-semibold">{flashcardsStats.total}</div>
                                ...
                                <div className="text-center p-3 bg-muted/50 rounded-lg flex flex-col items-center justify-center">
                                    <div className="flex flex-col items-center justify-center mb-2">
                                        <Badge 
                                            variant={
                                                flashcardsStats.knowledgePercentage >= 80 ? "default" : 
                                                flashcardsStats.knowledgePercentage >= 60 ? "secondary" : "destructive"
                                            }
                                    ...
                                    <div className="text-xs text-muted-foreground">Knowledge rate</div>
                                </div>
                            </div>
                        </div>
